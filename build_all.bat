...
"%CMAKE_PATH%\cmake.exe" ^
    -G "MinGW Makefiles" ^
    -DCMAKE_C_COMPILER="C:/workspace/mingw64/bin/gcc.exe" ^
    -DCMAKE_CXX_COMPILER="C:/workspace/mingw64/bin/g++.exe" ^
    -DCMAKE_MAKE_PROGRAM="C:/workspace/mingw64/bin/mingw32-make.exe" ^
    -DCMAKE_BUILD_TYPE=Release ^
    -DCMAKE_PREFIX_PATH="C:/workspace/mingw64" ^
    -DCMAKE_FIND_ROOT_PATH="C:/workspace/mingw64" ^
...
"C:/workspace/mingw64/bin/mingw32-make.exe" -j4
if errorlevel 1 (
...
echo.
echo [2/4] Copy libbinder-rpc into binder rust/sys/libs for linking
...
echo.
echo [4/4] Collect artifacts into dist\windows
...
echo build_all: OK > "%DIST%\README.txt"
echo RUST_TARGET=%RUST_TARGET% >> "%DIST%\README.txt"
